...
- `docker/` — isolated agent containers: `dev-repo` (`up` / `ls`), `docker-compose.yml`, `Dockerfile`, `herdr_config.toml`, `container_opencode.json`, plus `README.md` with SSH/herdr setup.
